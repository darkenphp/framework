...
class ConstructorParamTest extends TestCase
{
    ...
    public function testConstructorParamDeclarationOrder()
    {
        ...
        class declarationorder1 extends \Darken\Code\Runtime
        {
            ...
            public function renderFilePath(): string
            {
                return dirname(__FILE__) . DIRECTORY_SEPARATOR . 'declarationorder1.compiled.php';
            }
        }
        PHP);
        ...
        class declarationorder2 extends \Darken\Code\Runtime
        {
            public function __construct(mixed $beta, mixed $alpha)
            {
                $this->setData('constructorParams', 'beta', $beta);
                $this->setData('constructorParams', 'alpha', $alpha);
            }
            public function renderFilePath(): string
            {
                return dirname(__FILE__) . DIRECTORY_SEPARATOR . 'declarationorder2.compiled.php';
            }
        }
        PHP);
    }

    public function testConstructorParamOrderingWithExplicitOrder()
    {
        ...
        $x = new class {
            ...
            #[\Darken\Attributes\ConstructorParam('alpha', 1)]
            protected $first;
        };
        PHP, <<<'PHP'
        <?php /** @var \Darken\Code\Runtime $this Do not edit this file. It is auto-generated and changes will be overwritten during the next compile. */ ?><?php
        ...
        class orderingwithexplicit extends \Darken\Code\Runtime
        {
            public function __construct(mixed $alpha, mixed $beta)
            {
                $this->setData('constructorParams', 'alpha', $alpha);
            ...
            public function renderFilePath(): string
            {
                return dirname(__FILE__) . DIRECTORY_SEPARATOR . 'orderingwithexplicit.compiled.php';
            }
        }
        PHP);
    }

    public function testConstructorParamExplicitOrdering()
    {
        ...
        $x = new class {
            ...
            #[\Darken\Attributes\ConstructorParam('alpha', 3)]
            protected $first;
        ...
        $x = new class($this)
        {
            ...
            {
                $this->runtime = $runtime;
                $this->third = $this->runtime->getData('constructorParams', 'gamma');
                $this->first = $this->runtime->getData('constructorParams', 'alpha');
                $this->second = $this->runtime->getData('constructorParams', 'beta');
            }
        };
        ...
        class explicitorder extends \Darken\Code\Runtime
        {
            public function __construct(mixed $gamma, mixed $beta, mixed $alpha)
            {
                $this->setData('constructorParams', 'gamma', $gamma);
                $this->setData('constructorParams', 'beta', $beta);
                $this->setData('constructorParams', 'alpha', $alpha);
            }
            public function renderFilePath(): string
            {
                return dirname(__FILE__) . DIRECTORY_SEPARATOR . 'explicitorder.compiled.php';
            }
        }
        PHP);
    }

    public function testConstructorParamMixedOrdering()
    {
        ...
        $x = new class {
            ...
            #[\Darken\Attributes\ConstructorParam('alpha', 2)]  // Order 2
            protected $second;

            #[\Darken\Attributes\ConstructorParam('beta')]  // No order - should be after ordered
            protected $middle;

            #[\Darken\Attributes\ConstructorParam('gamma', 1)]  // Order 1 - should be first
            protected $first;
        };
        PHP, <<<'PHP'
        <?php /** @var \Darken\Code\Runtime $this Do not edit this file. It is auto-generated and changes will be overwritten during the next compile. */ ?><?php
        ...
        {
            protected \Darken\Code\Runtime $runtime;
            #[\Darken\Attributes\ConstructorParam('zulu')]
            protected $last;
            #[\Darken\Attributes\ConstructorParam('alpha', 2)]
            protected $second;
            #[\Darken\Attributes\ConstructorParam('beta')]
            protected $middle;
            #[\Darken\Attributes\ConstructorParam('gamma', 1)]
            ...
            {
                $this->runtime = $runtime;
                $this->last = $this->runtime->getData('constructorParams', 'zulu');
                $this->second = $this->runtime->getData('constructorParams', 'alpha');
                $this->middle = $this->runtime->getData('constructorParams', 'beta');
                $this->first = $this->runtime->getData('constructorParams', 'gamma');
            }
        };
        PHP, <<<'PHP'
        <?php /** Do not edit this file. It is auto-generated and changes will be overwritten during the next compile. */ ?><?php
        ...
        class mixedorder extends \Darken\Code\Runtime
        {
            public function __construct(mixed $gamma, mixed $alpha, mixed $beta, mixed $zulu)
            {
                $this->setData('constructorParams', 'gamma', $gamma);
                $this->setData('constructorParams', 'alpha', $alpha);
                $this->setData('constructorParams', 'beta', $beta);
                $this->setData('constructorParams', 'zulu', $zulu);
            }
            public function renderFilePath(): string
            {
                return dirname(__FILE__) . DIRECTORY_SEPARATOR . 'mixedorder.compiled.php';
            }
        }
        PHP);
    }
