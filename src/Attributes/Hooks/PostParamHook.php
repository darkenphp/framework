...
class PostParamHook extends PropertyAttributeHook
{
    public function compileConstructorHook(PropertyAttribute $attribute, ClassMethod $constructor): ClassMethod
    {
        $constructor->stmts[] = $attribute->createPostParamExpressionForCompile();
        return $constructor;
    }
    ...
    {
        return $attribute->getDecoratorAttributeName() === PostParam::class;
    }
